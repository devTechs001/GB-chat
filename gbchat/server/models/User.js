...
const userSchema = new mongoose.Schema(
  {
    ...
    theme: {
      ...
      showNetworkIndicator: { type: Boolean, default: true },
      showConnectionQuality: { type: Boolean, default: true },
      showLastSeenExact: { type: Boolean, default: false },
      showDeliveryTime: { type: Boolean, default: false },
      chatEffects: { type: String, default: "none" },
      messageAnimation: { type: String, default: "slide" },
      highContrast: { type: Boolean, default: false },
      reduceMotion: { type: Boolean, default: false },
      compactMode: { type: Boolean, default: false },
      customColors: { type: Object, default: {} },
      gradientTheme: { type: Boolean, default: false },
      darkModeLevel: { type: String, default: "default", enum: ["default", "dark", "darker", "amoled"] },
    ...
    notifications: {
      ...
      archiveOnMute: { type: Boolean, default: false },
      saveToGallery: { type: Boolean, default: false },
      mediaQuality: { type: String, default: "auto", enum: ["auto", "high", "medium", "low"] },
      desktop: { type: Boolean, default: true },
      messagePreview: { type: Boolean, default: true },
      permissionRequested: { type: Boolean, default: false },
    ...
    chatSettings: {
      autoReply: {
        ...
        onlyForGroups: { type: Boolean, default: false },
        schedule: {
          enabled: { type: Boolean, default: false },
          startTime: String,
          endTime: String,
      ...
      quickReactions: [{ type: String, default: () => ["❤️", "👍", "😂", "😮", "😢", "🙏"] }],
      chatFolders: [{
        id: String,
        name: String,
        color: String,
      ...
      messageTranslation: { type: Boolean, default: false },
      defaultLanguage: { type: String, default: "en" },
      inlineReply: { type: Boolean, default: true },
      swipeActions: {
        left: { type: String, default: "archive", enum: ["archive", "mute", "delete", "read", "pin"] },
        right: { type: String, default: "mute", enum: ["archive", "mute", "delete", "read", "pin"] },
      },
      doubleTapToReply: { type: Boolean, default: true },
      sendButtonBehavior: { type: String, default: "send", enum: ["send", "emoji"] },
      confirmBeforeDelete: { type: Boolean, default: true },
      showChatPreview: { type: Boolean, default: true },
      prioritizeUnread: { type: Boolean, default: true },
      autoArchive: {
        enabled: { type: Boolean, default: false },
        afterDays: { type: Number, default: 365 },
      },
    },
