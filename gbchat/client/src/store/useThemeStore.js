...
const themes = {
  ...
  emerald: {
    name: 'Emerald',
    class: 'dark theme-emerald',
    primary: '#10b981',
    background: '#022c22',
    emoji: '💎',
    description: 'Rich green jewel',
  },
  twilight: {
    name: 'Twilight',
    class: 'dark theme-twilight',
    primary: '#818cf8',
    background: '#0f0c29',
    emoji: '🌆',
    description: 'Dusk purple-blue',
  },
  sakura: {
    name: 'Sakura',
    class: 'light theme-sakura',
    primary: '#ec4899',
    background: '#fff5f9',
    emoji: '🌸',
  ...
  moonlight: {
    name: 'Moonlight',
    class: 'light theme-moonlight',
    primary: '#6366f1',
    background: '#f0f4ff',
    emoji: '🌙',
    description: 'Soft silver-blue',
  },
}
